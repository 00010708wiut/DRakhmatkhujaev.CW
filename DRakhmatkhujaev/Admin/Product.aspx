<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="DRakhmatkhujaev.Admin.Product" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn btn-primary"
                                                ...
                                                <div>
                                                    <asp:Image ID="imgProduct" runat="server" CssClass="img-thubnail" />
                                                </div>
                                            </div>
                                        </div>
