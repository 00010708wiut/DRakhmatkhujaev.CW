<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="DRakhmatkhujaev.User.Registration" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="txtMobile" runat="server" CssClass="form-control" placeholder="Enter Mobile nomber"
                ...
                <div class="row pl-4">
                    <div class="btn_box">
                        ...
                        <asp:Label ID="lblAlredyUser" runat="server" CssClass="pl-3 text-black-100"
